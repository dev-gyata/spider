...
void main() {
  ...
  group('Utils tests', () {
    ...
    test('checkFlutterProject test', () async {
      addTearDown(() async {
        await File(
          p.join(Directory.current.path, 'pubspec.txt'),
        ).rename('pubspec.yaml');
    ...
    test('getExportContent test', () async {
      expect(
        getExportContent(fileNames: ['test.dart'], noComments: true),
        equals("export 'test.dart';"),
      );

      expect(
        getExportContent(fileNames: ['test.dart'], noComments: false),
  ...
  group('validateConfigs tests', () {
    ...
    test('fonts config tests', () async {
      ...
      result = validateConfigs(
        baseConfig..['fonts'] = <String, dynamic>{},
        fontsOnly: true,
      );
      expect(result.isSuccess, isTrue);
    });
